...
export function HeaderMenuTemp({
  DataMenuItems,
  className,
}: {
  DataMenuItems: Props[];
  ...
  return (
    <div
      className={cn(
        "h-[100%] items-center bg-[rgba(0,0,0,0.7)]",
    ...
    >
      <div className="w-full">
        <div className="flex flex-row justify-between mt-2 w-full gap-1">
          {/* Item menu */}
          {DataMenuItems?.map((item) => {
            return (
              ...
              >
                <div className="flex flex-col gap-1 text-lg text-white font-light uppercase">
                  {item.title}
                  {/* <span
